...
all_files = list()
with open("sike_only_bulgarian.txt", "r") as f:
    for line in f:
        all_files.append(line.strip())

for test_file in all_files:
    current_gold_file = test_file 
    language_name = test_file.split('/')[2] + '_predicted_valmetareal.conllu'
    performance_name = test_file.split('/')[2] + '_results_valmetareal.json'
