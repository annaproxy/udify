...
for test_file in all_files:
    ...
    language_name = test_file.split('/')[2] + '_predicted_metalearnlowlr_bulgarian.conllu'
    performance_name = test_file.split('/')[2] + '_results_metalearnlowlr_bulgarian.json'
    ...
    util.predict_and_evaluate_model(
        "udify_predictor",
        get_params(),
        "finetunelowlr160", #logs/english_only_expmix4/2020.05.13_01.43.52,
        current_gold_file,
        current_pred_file,
        current_output_file,
        batch_size=16
